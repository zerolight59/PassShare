...
public class groupRecyclerview_1 extends RecyclerView.Adapter<groupRecyclerview_1.MyViewHoldedr> {

    private final groupRecyclerviewInterface recyclerviewInterface;

    Context context;
    ArrayList<DBGroup> dbGroups;
    public groupRecyclerview_1(Context context, ArrayList<DBGroup> dbGroups,groupRecyclerviewInterface recyclerviewInterface) {
    ...
    @NonNull
    @Override
    public groupRecyclerview_1.MyViewHoldedr onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater=LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.recyclerview_row,parent,false);
        return new groupRecyclerview_1.MyViewHoldedr(view,recyclerviewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull groupRecyclerview_1.MyViewHoldedr holder, int position) {
