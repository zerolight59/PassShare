...
public class Viewgroup extends AppCompatActivity implements groupRecyclerviewInterface{
    ...
    private void setDbGroups(){
        SessionManagement sessionManagement = new SessionManagement(Viewgroup.this);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(Viewgroup.this,Viewser.class);
